...
export const TEMPLATES: Template[] = [
  ...
  { id: "instagram-reel", name: "Instagram Reel", description: "Viral reel templates", type: "video", model: "pixverse/pixverse-v6", style: "cinematic", aspectRatio: "9:16", examplePrompt: "A dynamic fast-paced montage of street food being prepared with vibrant colors and steam", emoji: "📱", premium: true },
  { id: "youtube-intro", name: "YouTube Intro", description: "Channel intro animation", type: "video", model: "bytedance/seedance-1-pro", style: "cinematic", aspectRatio: "16:9", examplePrompt: "A cinematic countdown intro with neon lights and particle effects for a gaming channel", emoji: "▶️", premium: true },
  { id: "ecommerce-360", name: "Product 360°", description: "360 product showcase", type: "video", model: "pixverse/pixverse-v6", style: "3d-render", aspectRatio: "1:1", examplePrompt: "A 360-degree rotating view of a designer sneaker with dynamic lighting", emoji: "👟", premium: true },
  { id: "cinematic-drama", name: "Cinematic Drama", description: "Film-style scenes", type: "image", model: "black-forest-labs/flux-dev", style: "cinematic", aspectRatio: "16:9", examplePrompt: "A dramatic film scene of a lone figure walking through a rain-soaked alley at night", emoji: "🎬", premium: true },
  { id: "logo-reveal", name: "Logo Reveal", description: "Brand logo animation", type: "video", model: "bytedance/seedance-1-pro", style: "cinematic", aspectRatio: "1:1", examplePrompt: "A sleek golden logo reveal with light particles and smooth transitions on dark background", emoji: "✨", premium: true },
]
